(window.webpackJsonp = window.webpackJsonp || []).push([["chunk-7fa6e08b"], {
    "11be": function (t, e, a) {
    }, "1b26": function (t, e, a) {
        "use strict";
        a.d(e, "e", (function () {
        ...
        var i = a("5530"), n = a("1b26"), s = a("d294"),
                    ...
                    handleSubmit: function () {
                        ...
                        this.form.validateFields((function (e, a) {
                            if (t.nameString || (t.isEmpty = !0), !e) {
                                ...
                                Object(n.g)(Object(i.a)({}, s)).then((function (e) {
                ...
                components: {
                    issuedTask: Object(o.a)(r, (function () {
                        ...
                        return a("a-modal", {
                            ...
                            attrs: {allowClear: "", placeholder: "请输入任务名称"},
                            on: {
                                change: function (e) {
                                    t.isEmpty = !1
                                }
                    ...
                    searchData: function (t, e) {
                        ...
                        return !0 === t.npoc_service_detection && e.settingArray.push(s.c.npoc_service_detection), "自定义" === e.scanType && (e.port_custom = t.ip_config.port_custom), t.site_config.web_info_hunter && e.settingArray.push(s.c.web_info_hunter), e
                    }, getSiteConfig: function (t) {
                        var e = !1, a = [];
                        for (var i in t.site_config) !0 === t.site_config[i] && (e = !0, a.push(s.g[i]));
                        return !0 === t.file_leak && a.push(s.g.file_leak), e ? a : null
        ...
        var i = [{value: "domain_brute", name: "域名爆破"}, {
                value: "alt_dns",
                name: "DNS字典智能生成"
                ...
                value: "ssl_cert",
                name: "SSL 证书获取"
            }, {value: "skip_scan_cdn_ip", name: "跳过CDN"}, {value: "npoc_service_detection", name: "服务(python)识别"}],
            n = [{value: "site_identify", name: "站点识别"}, {
                value: "search_engines",
                name: "搜索引擎调用"
            }, {value: "site_spider", name: "站点爬虫"}, {value: "site_capture", name: "站点截图"}, {
                value: "file_leak",
                name: "文件泄露"
            }, {value: "nuclei_scan", name: "nuclei 调用"}, {value: "web_info_hunter", name: "WIH 调用"}],
            s = {big: "大字典", test: "测试"},
